...
from main.views import show_main, create_product, delete_product, show_products, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user, increment_amount, decrement_amount
